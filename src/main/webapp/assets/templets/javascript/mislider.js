...
var MiSlider = function( stageEl, options ) {
	...
	o.addNavButtons = function( element ) {
		...
		navButtons = $( "<div class='" +
			...
			"'><a href='#' class='" +
			o.classPrev +
			"'><div style='background-size: 35px 35px;background-image: url(/templets/default/img/mis-prev-icon.svg);    background-repeat: no-repeat;width: 35px;height: 35px;'></div></a><a href='#' class='" +
			o.classNext +
			"'><div style='background-size: 35px 35px;background-image: url(/templets/default/img/mis-next-icon.svg);    background-repeat: no-repeat;width: 35px;height: 35px;'></div></a></div>");
		...
		$el.parent().append( navButtons );

		// Define cached objects
		o.navButtons = $el.parent().find("." + o.options.classNavButtons);
		...
		if ( o.navButtons ) {
			...
			o.navButtons
				...
				.children( "a" )
					.css({
						"height": o.stageHeight,
						"paddingTop": ( 30 + o.offsetV ) * o.stageHeight / 100
					})
			;
		}
	};
