...
<head profile="http://www.w3.org/1999/xhtml/vocab">
    ...
    <link rel="shortcut icon" href="https://vipp.com/misc/favicon.ico" type="image/vnd.microsoft.icon"/>

    <meta name="description" content="List product description english"/>
    ...
    <meta property="og:url" content="https://vipp.com/en/products"/>
    <meta property="og:title" content="Products"/>
    <meta property="og:description" content="List product description english"/>
    <meta property="og:updated_time" content="2017-09-19T07:28:39+02:00"/>
    <meta property="article:published_time" content="2016-12-13T11:16:01+01:00"/>
    <meta property="article:modified_time" content="2017-09-19T07:28:39+02:00"/>
    <title>Products | vipp.com</title>
    <meta name="viewport"
          content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0">
    <meta name="google" content="notranslate"/>

    <!-- ****** faviconit.com favicons ****** -->
    <link rel="shortcut icon" href="${ctx}/assets/images/favicons/favicon.ico">
    <link rel="icon" sizes="16x16 32x32 64x64" href="${ctx}/assets/images/favicons/favicon.ico">
    <link rel="icon" type="image/png" sizes="196x196" href="${ctx}/assets/images/favicons/android-chrome-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="${ctx}/assets/images/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="${ctx}/assets/images/favicons/favicon-16x16.png">
    <link rel="icon" sizes="any" mask href="${ctx}/assets/images/favicons/safari-pinned-tab.svg">
    <link rel="apple-touch-icon" sizes="114x114" href="${ctx}/assets/images/favicons/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="72x72" href="${ctx}/assets/images/favicons/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="144x144" href="${ctx}/assets/images/favicons/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="60x60" href="${ctx}/assets/images/favicons/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="120x120" href="${ctx}/assets/images/favicons/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="76x76" href="${ctx}/assets/images/favicons/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="152x152" href="${ctx}/assets/images/favicons/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="180x180" href="${ctx}/assets/images/favicons/apple-touch-icon.png">
    ...
    <link type="text/css" rel="stylesheet" href="${ctx}/assets/css/css_xE-rWrJf-fncB6ztZfd2huxqgxu4WO-qwma6Xer30m4.css"
          media="all"/>
    <link type="text/css" rel="stylesheet" href="${ctx}/assets/css/css_PcABlw6ce_EkG1XwW2639OHCVIBkV1COfSV90hDxHUc.css"
          media="all"/>
    <link type="text/css" rel="stylesheet" href="${ctx}/assets/css/css_Wu8npAzy16WmnnnWKxpexfgsAryolGGaX6yO3GWA5bU.css"
          media="all"/>
    <link type="text/css" rel="stylesheet" href="${ctx}/assets/css/css_o0_TRfdZ8vtJI6TlY5PZjDF_5lxb2PdgCfkfFqmvAKU.css"
          media="all"/>
    <script type="text/javascript" src="${ctx}/assets/js/js_MhmpaHtu9ftmVRCNk9W_BEAxENcS1dULnkDSkzq6YzM.js"></script>
    <script type="text/javascript" src="${ctx}/assets/js/modernizr.customa53d.js?piw6eo"></script>
    <script type="text/javascript" src="${ctx}/assets/js/js_gPqjYq7fqdMzw8-29XWQIVoDSWTmZCGy9OqaHppNxuQ.js"></script>
...
<div class="popup-container" id="country_popup">
    <div class="popup-box list-country">
        ...
        <div class="popup-content">
            <form action="https://vipp.com/en/products" method="post" id="e-common-form-change-country--2"
                  accept-charset="UTF-8">
                <div>
                    <div class="form-item form-type-select form-item-country">
                    ...
                    <input type="submit" id="edit-submit--3" name="op" value="OK" class="form-submit"/><input
                        type="hidden" name="form_build_id" value="form-ROQgS3MZ07uUTXqoYSmVHR_fsN0fNV_EioNgyEVRQnk"/>
                    <input type="hidden" name="form_id" value="e_common_form_change_country"/>
                </div>
            </form>
        </div>
...
<div class="footer">
    ...
    <div class="social-links">
        <a href="https://www.instagram.com/vipp/" target="_blank"><img
                src="${ctx}/assets/images/common/icon-social-04%402x.png" alt="instagram"/></a><a
            href="https://www.facebook.com/vippdotcom/" target="_blank"><img
            src="${ctx}/assets/images/common/icon-social-01%402x.png" alt="facebook"/></a><a
            href="https://www.pinterest.com/vippdotcom/" target="_blank"><img
            src="${ctx}/assets/images/common/icon-social-03%402x.png" alt="pinterest"/></a><a
            href="https://www.linkedin.com/company/vipp" target="_blank"><img
            src="${ctx}/assets/images/common/icon-social-06%402x.png" alt="linkedin"/></a><a
            href="https://www.youtube.com/user/vippdesign" target="_blank"><img
            src="${ctx}/assets/images/common/icon-social-05%402x.png" alt="youtube"/></a><a
            href="https://twitter.com/vipp" target="_blank"><img
            src="${ctx}/assets/images/common/icon-social-02%402x.png" alt="twitter"/></a></div>

    <ul>
        <li><a href="content/contact.html">Contact</a></li>
        <li><a href="http://eepurl.com/dtywsz">Newsletter</a></li>
        <li><a href="content/press.html">Press</a></li>
    </ul>

    <div class="copyright">COPYRIGHT @ VIPP 2018</div>
    <div class="term">
        <a href="content/terms-and-conditions.html">Terms and conditions</a></div>
</div>

<div id="cookie" class="clearfix">
    <div class="f_left"><p>We use cookies to improve our site and your shopping experience. By continuing to browse our
        site you accept our cookie policy. <a href="content/terms-and-conditions.html" target="_blank">Find out more&nbsp;</a>
    </p></div>
    <div class="f_right"><input type="button" class="button" value="Close"/></div>
</div>

<script type="text/javascript" src="${ctx}/assets/js/js_PdiuypZMI8o81AYEdTHwjRslVPEF69JFzr7Y9sMWt4s.js"></script>
<script type="text/javascript" src="${ctx}/assets/js/js_Vn03Y9rfBazBeKOL_NkVRa5gVN_NmOG0czLxUAp4i5Y.js"></script>
<script type="text/javascript" src="${ctx}/assets/js/js_Loj97lZJHSEu053NBHnQrNaBFg7JBliwVFp4gxVLy_A.js"></script>
